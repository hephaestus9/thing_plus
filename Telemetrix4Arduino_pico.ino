...
void set_ws2812() {
  #ifdef WS2812
    // get values from command buffer and post them
    ...
    for(int i=0; i<NUMPIXELS; i++) { // For each pixel...
      ...
      pixels.setPixelColor(i, pixels.Color(command_buffer[0], command_buffer[1], command_buffer[2]));
